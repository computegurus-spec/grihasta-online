...
export const INITIAL_AMENITIES: Amenity[] = [
  { id: 'AMN-1', name: 'Grihasta Clubhouse Party Hall', description: 'Air-conditioned hall with seating for 120 guests, audio system, and pantry area.', iconName: 'Building', capacity: 120, operatingHours: '09:00 AM - 11:00 PM', rules: ['No loud music after 10 PM', 'Clean up required after event', 'Security deposit ₹2,000'] },
  ...
  { id: 'AMN-5', name: 'Car Washing Facility / Bay', description: 'Dedicated high-pressure wash bay with drainage channels and eco-friendly wash setup for layout vehicles.', iconName: 'Car', capacity: 2, operatingHours: '07:00 AM - 06:00 PM', rules: ['Use eco-friendly detergent only', 'Turn off pressure hose when scrubbing', 'Clean wash bay area post-wash', 'Slot limited to 45 mins per vehicle'] }
];
...
export const INITIAL_GROUPS: InterestGroup[] = [
  { id: 'GRP-1', name: 'Grihasta Parents Forum', category: 'Parents', description: 'Group for parents in the layout to coordinate playdates, school bus drop-offs, and kids sports activities.', membersCount: 0, joinedFlatIds: [], iconName: 'Users' },
